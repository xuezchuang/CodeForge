//! Shared CodeForge goal state model.
//!
//! Both the Tauri desktop host and the standalone TUI use this shape for
//! `/goal` state. The TUI also persists it under the configured CodeForge
//! home directory.
//!
